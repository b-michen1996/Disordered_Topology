...
def Fig_2(location_a, location_b, location_data_inset_a, location_data_inset_b, location_data_a_p2 = None, location_data_b_p2 = None, location_data_a_p3 = None, location_data_b_p3 = None):
    ...
    try:
        data_a_p2 = np.genfromtxt(location_data_a_p2 + "/result.txt", dtype= float, delimiter=' ')  
        data_b_p2 = np.genfromtxt(location_data_b_p2 + "/result.txt", dtype= float, delimiter=' ')  
        
        data_a[:, n_data_cut_a_1:] = data_a_p2[:, n_data_cut_a_1:]
        data_b[:, n_data_cut_b_1:] = data_b_p2[:, n_data_cut_b_1:]
    ...
    try:
        data_a_p3 = np.genfromtxt(location_data_a_p3 + "/result.txt", dtype= float, delimiter=' ')  
        data_b_p3 = np.genfromtxt(location_data_b_p3 + "/result.txt", dtype= float, delimiter=' ')  
        
        data_a[:, n_data_cut_a_2:] = data_a_p3[:, n_data_cut_a_2:]
        data_b[:, n_data_cut_b_2:] = data_b_p3[:, n_data_cut_b_2:]
...
def Fig_2_vertical(location_a, location_b):
    ...
    fig.savefig("Fig_2_publication.png",  bbox_inches='tight', dpi = 200)
...
def main():                
    ...
    Fig_2(location_G_final_V3_a, location_G_final_V3_b, location_data_inset_a, location_data_inset_b, location_data_a_p2, location_data_b_p2, location_data_a_p3, location_data_b_p3)
