...
def Fig_3_App(location, n_vals = 1):
    ...
    fig.tight_layout()
    fig.savefig("Fig_3_App_publication.png",  bbox_inches='tight', dpi = 200)
...
def Fig_2_App(location, n_vals = 1):
    ...
    fig.tight_layout()
    fig.savefig("Fig_2_App_publication.png",  bbox_inches='tight', dpi = 200)
    
    return


def main():                       
    location = "G_final_V3_Hall_line_run_26"    
    
    
    n_vals = 16

    Fig_2_App(location, n_vals)
    #Fig_3_App(location, n_vals)
